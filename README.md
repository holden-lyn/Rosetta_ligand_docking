...
"RosettaLigand_tutorial"文件夹里有流程的输入文件和处理过程中生成的文件，"RosettaLigand_tutorial/Results"里有运行分子对接设计之后输出的文件。
...
<p align="center">
  <img  src="RosettaLigand_picture/Avogadro_add_H_for_pH.png">
</p>
...
**UCSF Chimera** 是本次教程中使用的，将小分子放进蛋白质口袋的软件。确认蛋白质的口袋位置需要一些先验知识，这次教程中情况相对简单。在https://www.uniprot.org/uniprotkb/P77366/entry 上可以看到蛋白质的活性位点是第11位的氨基酸，在Chimera中打开蛋白质.pdb结构文件，可以在Chimera中选中这个氨基酸达到高亮它的效果，同时也能发现这个蛋白质的口袋相当明显，活性位点所在的位置也与口袋的位置相吻合。  
